...
class Camera:
    def __init__(self, param_data_path='', camera_name=0, resolution=(640, 480)):
        self.cap = None
...
if __name__ == '__main__':
    # 使用例程
    import os
    param_data_path = os.path.join(os.environ['HOME'], 'Documents/std_comp/running-robot/include/calibration_param.npz')
